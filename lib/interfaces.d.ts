export declare type fromSymbol = string;
export declare type toSymbol = string;
export declare type market = string;
...
export declare type PriceHistoricalResponse = PriceMultiResponse;
